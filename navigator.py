...
if __name__ == '__main__':
    gamma = 0.1
    delta = 4.0
    threshold_list = [0.3, 0.6, 0.9, 1.2, 1.5]
    method = 'ie'
    dataset = 'humaneval'
    if dataset == 'mbpp':
        beam_size = 20
    ...
    human_file = 'path_to_human_evaluation_file'
    machine_file = 'path_to_machine_evaluation_file'
    navigator = Navigator(
        dataset,
        beam_size,
        threshold_list,
    ...
    navigator.print_result()
    print('==' * 10 + 'Change the direction' + '==' * 10)
    navigator = Navigator(
        dataset,
        beam_size,
        threshold_list,
